// Path: src/strategy-executor.ts
// Deployment strategy executor for canary/rolling deployments

import type { DeploymentStrategy, DeployToHostResult, StrategyProgressReporter } from './types.js';
...
export interface StrategyExecutorOptions {
  ...
  progress?: StrategyProgressReporter;
}
