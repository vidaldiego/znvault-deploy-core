...
// Deploy-core constants and configuration values.
//
// NOTE: This is the target-agnostic subset of the original
// `znvault-plugin-payara/src/cli/constants.ts`. That file also defined
// payara-specific config file paths (CONFIG_DIR / PAYARA_CONFIG_DIR /
// CONFIG_FILE / LEGACY_CONFIG_FILE) which stay in the plugin — config
// file location is a per-deployer-plugin concern, not deploy-core's.
